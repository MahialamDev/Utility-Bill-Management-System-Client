        ...
        >
          ...
          <td>
            <div className="flex items-center gap-4">
              ...
              <div className="truncate">
                ...
                <div className="text-sm opacity-60 truncate">{myPayBill.email}</div>
              </div>
            </div>
          </td>

          <td>
            <span className="font-medium text-green-600">${myPayBill.amount}</span>
          </td>

          <td>
            <span className="text-sm truncate">{myPayBill.address}</span>
          </td>
          ...
          <th>
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-2">
              ...
              <button className="btn btn-sm btn-error text-white hover:scale-105 transition-transform w-full sm:w-auto">
                Delete
              </button>
            </div>
          </th>
